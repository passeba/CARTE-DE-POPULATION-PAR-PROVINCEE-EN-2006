...
map.getView().fit([-693444.447932, 958545.739961, 442002.780496, 1788365.988175], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DISTRIBUTION SPATIALE DE LA POPULATION PAR PROVINCE EN 2006</h2>';
        return titleElement;
    })(),
